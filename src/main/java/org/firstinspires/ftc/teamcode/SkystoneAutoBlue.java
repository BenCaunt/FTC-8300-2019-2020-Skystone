...
public class SkystoneAutoBlue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        encoderDriveIMU(DRIVE_SPEED,7.25,7.25,5);
        // close claw down
        closeClaw();
        ...
        sleep(350);
        // drive backward
        encoderDriveIMU(DRIVE_SPEED,-4.5,-4.5,5);
        ...
        if (midvaluedetect == 0) {
            encoderDriveIMU(1,58,58,5);
        }

        if (leftvaluedetect == 0) {

            encoderDriveIMU(1,48,48,5);

        }

        if (rightvaluedetect == 0) {
            encoderDriveIMU(1,62,62,5);
        ...
        if (true) {
            ...
            encoderStrafe(DRIVE_SPEED,8.7,-8.7,5);
            // side claw down
            autoClawDown();
            sleep(650);
            // strafe into build zone
            encoderStrafe(DRIVE_SPEED-0.4,-45,45,5);
            /*
            ...
            */
            ...
            //encoderDrive(DRIVE_SPEED,35,35,6);
             ...
             */
            // drive to parking line
            encoderDrive(1,26,26,6);
            // strafe to second position
            encoderStrafe(1,18,-18,5);
            // drive into platform

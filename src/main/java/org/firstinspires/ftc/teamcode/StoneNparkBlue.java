 ...
 */
@Autonomous
public class StoneNparkBlue extends LinearOpMode {
...
//            moveDistance(0.4, 700);
        ...
        encoderDriveIMU(DRIVE_SPEED,-18,-18,5);
        // deploy claw
        // arm up
        ...
        if (leftvaluedetect == 0) {
            ...
            encoderStrafe(DRIVE_SPEED, -28, 28, 5);
        } else if (rightvaluedetect == 0) {
            encoderStrafe(DRIVE_SPEED,-35,35,5);
        }
        ...
        sleep(300);
        // drive back
        encoderDrive(0.75,-11,-11,5);
        // turn to sky bridge
        encoderDrive(TURN_SPEED,-17.25,17.25,5);
